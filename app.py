...
if pilihan == "Halaman Utama":
    ...
    st.markdown(
        ...
        <br><br>
        Kami percaya bahwa dengan mengenal kekayaan rempah-rempah Indonesia, Anda tidak hanya mendapatkan inspirasi untuk eksplorasi kuliner, 
        tetapi juga apresiasi terhadap warisan budaya dan manfaat kesehatan yang dianut sejak dahulu kala. Aplikasi ini juga bertujuan untuk 
        mendukung pelestarian tradisi melalui dukungan teknologi modern, sehingga pengetahuan mengenai rempah dapat diakses lebih mudah dan luas oleh semua orang.
        </p>
        """, 
        unsafe_allow_html=True
    )
